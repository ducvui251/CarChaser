...
namespace CrashyChasy
{
    public class AdDisplayer : MonoBehaviour
    {
        ...
        public static event System.Action SkipedRewardedAdToRecoverLostGame;
        ...
        public void ShowRewardedAdToRecoverLostGame()
        {
            if (CanShowRewardedAd())
            {
                ...
                Advertising.RewardedAdSkipped += OnSkipRewardedAdToRecoverLostGame;
        ...
        void OnSkipRewardedAdToRecoverLostGame(RewardedAdNetwork adNetwork, AdPlacement location)
        {
            // Unsubscribe
            Advertising.RewardedAdCompleted -= OnCompleteRewardedAdToRecoverLostGame;
            Advertising.RewardedAdSkipped -= OnSkipRewardedAdToRecoverLostGame;
            // Fire event
            if (SkipedRewardedAdToRecoverLostGame != null)
            {
                SkipedRewardedAdToRecoverLostGame();
            }
        }
